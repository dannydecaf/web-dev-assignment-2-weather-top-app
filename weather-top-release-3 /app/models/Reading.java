...
public class Reading extends Model {
    ...
    public String trendingTemp;
    public String trendingWindSpeed;
    public String trendingPressure;
    ...
    public void setTrendingTemp(String trendingTemp) {
        this.trendingTemp = trendingTemp;
    }

    public void setTrendingWindSpeed(String trendingWindSpeed) {
        this.trendingWindSpeed = trendingWindSpeed;
    }

    public void setTrendingPressure(String trendingPressure) {
        this.trendingPressure = trendingPressure;
    }
}